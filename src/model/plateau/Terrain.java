...
public enum Terrain
{
    CHAMPS("Champs", "field", "CHAM", "#fbc02d"),
    CHATEAU("Chateau","castle", "CHAT", "#000000"),
    FORET("Foret","forest", "FORE", "#2e7d32"),
    MER("Mer","water", "MER-","#2196f3"),
    PRAIRIE("Prairie", "pasture", "PRAI", "#8bc34a"),
    MONTAGNE("Montagne", "clay", "MONT", "#6D4C41"),
    MINE("Mine","mine", "MINE", "#607D8B");
     ...
     * @param hexColor
     */
    Terrain(String libelle, String libelleEN, String diminutif, String hexColor){
    ...
    /**
     * Methode retournant le terrain en fonction du nom anglais du terrain
     * @param nom Le nom du terrain
     * @return Le terrain
     */
    public static Terrain getTerrainEN(String nom){
        for(int i = 0; i < values().length; i++){
            if(nom.equals(values()[i].getLibelleEN())){
                return values()[i];
            }
        }
        return null;
    ...
    /**
     * Methode retournant le nom anglais du terrain
     * @return Le nom du terrain
     */
